package com.example.mysymptomanalyzer.Config;
...
public class SymptomList {
    ...
    static String[] symptoms = {"abdomen acute","abdominal tenderness","abnormally hard consistency",
            "abortion","abscess bacterial","absences finding","achalasia","agitation",
            "air fluid level","alcohol binge episode","ambidexterity","angina pectoris",
            "anorexia","anosmia","aphagia","apyrexial","arthralgia","ascites","asterixis",
            "asthenia","ataxia","atypia","aura","bedridden","behavior hyperactive","blackout",
            "bradycardia","bradykinesia","breakthrough pain","breath sounds decreased",
            "breech presentation","bruit","burning sensation","cardiomegaly","cardiovascular event",
            "cardiovascular finding","catatonia","catching breath","charleyhorse","chest discomfort",
            "chest tightness","chill","cicatrisation","clonus","clumsiness","colic abdominal",
            "consciousness clear","constipation","cough","cushingoid facies","cushingoid habitus",
            "cyanosis","cystic lesion","debilitation","decompensation","decreased body weight",
            "diarrhea","difficulty","difficulty passing urine","disequilibrium","distended abdomen",
            "distress respiratory","disturbed family","dizziness","dizzy spells","drool",
            "drowsiness","dysarthria","dysdiadochokinesia","dysesthesia","dyspnea",
            "dyspnea on exertion","dysuria","ecchymosis","egophony","emphysematous change",
            "energy increased","enuresis","erythema","estrogen use","exhaustion",
            "extrapyramidal sign","extreme exhaustion","facial paresis","fall","fatigability",
            "fatigue","fear of falling","fecaluria","feces in rectum","feeling hopeless",
            "feeling strange","feeling suicidal","feels hot/feverish","fever","flare",
            "flatulence","food intolerance","formication","frail","gasping for breath",
            "general discomfort","general unsteadiness","gravida 0","green sputum","groggy",
            "guaiac positive","gurgle","haemoptysis","haemorrhage","hallucinations auditory",
